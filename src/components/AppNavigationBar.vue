...
<template>
  <header class="relative bg-black-90">
    <div class="container mx-auto">
      <nav
        class="flex flex-nowrap items-start pt-8 pb-9 shadow-[0_1px_0px_0px_rgba(255,255,255,0.2)]"
        aria-label="Main navigation"
      >
        <!-- logo/brand starts -->
        <a
          class="logo text-white transition p-0 mr-0 inline-flex items-center hover:text-orange-100"
          href="/"
        ...
        <div class="flex">
          <button
            class="text-white border-0 outline-0 hover:text-orange-100"
            type="button"
          >
            <svg
              width="23"
